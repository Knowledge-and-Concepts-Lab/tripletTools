...
**Progress monitoring.** Because worker output is not forwarded to the main session, the `verbose` progress messages are suppressed automatically. Install `progressr` to get a progress bar showing completions instead:
