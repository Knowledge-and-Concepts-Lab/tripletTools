...
1. Save your triplet data as the named list of participant data frames these functions already expect (the same format `get.combined()` returns and `icon_triplets` uses):
