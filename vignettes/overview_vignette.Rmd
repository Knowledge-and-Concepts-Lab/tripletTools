...
The result is a 5 × 5 matrix. Entry [i, j] is the accuracy with which participant i's embedding predicts participant j's held-out judgments. The diagonal contains each participant's *self-prediction* accuracy.
