...
#'
#' @return A real-valued number indicating the proportion of trials (of the
...
#' then compares this to the true answer and computes the proportion of trials
#' for which the prediction is matched.
#'
